...
} from "@/server/controllers/address.controller";

const ROUTES = {
  "POST:/add":      [[auth], addAddressController],
  "GET:/get":       [[auth], getAddressController],
  "PUT:/update":    [[auth], updateAddressController],
  "DELETE:/delete": [[auth], deleteAddressController],
};
