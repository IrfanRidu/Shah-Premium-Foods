...
import {
  ...
  quickSaleController,
} from "@/server/controllers/barcode.controller";

const ROUTES = {
  "GET:/lookup":     [[auth, checkPermission("inventory", "view")], lookupBarcodeController],
  "POST:/quick-sale":[[auth, checkPermission("inventory", "edit")], quickSaleController],
};
