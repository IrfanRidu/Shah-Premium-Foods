...
import {
  ...
  clearCartController,
} from "@/server/controllers/cart.controller";

const ROUTES = {
  "POST:/add":        [[auth], addToCartItemController],
  "GET:/get":         [[auth], getCartItemController],
  "PUT:/update-qty":  [[auth], updateCartItemQtyController],
  "DELETE:/delete":   [[auth], deleteCartItemController],
  "DELETE:/clear":    [[auth], clearCartController],
};
