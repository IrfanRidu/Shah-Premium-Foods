...
const ROUTES = {
  "POST:/add-category": [[auth, checkPermission("categories", "create")], addCategoryController],
  "GET:/get":           [[], getCategoriesController],
  "PUT:/update":        [[auth, checkPermission("categories", "edit")],   updateCategoryController],
  "DELETE:/delete":     [[auth, checkPermission("categories", "delete")], deleteCategoryController],
};
