...
} from "@/server/controllers/subcategory.controller";

const ROUTES = {
  "POST:/add":      [[auth, checkPermission("categories", "create")], addSubCategoryController],
  "GET:/get":       [[], getSubCategoriesController],
  "PUT:/update":    [[auth, checkPermission("categories", "edit")],   updateSubCategoryController],
  "DELETE:/delete": [[auth, checkPermission("categories", "delete")], deleteSubCategoryController],
};
