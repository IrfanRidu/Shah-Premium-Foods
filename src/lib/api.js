...
const api = {
  ...
  getFrequentlyBoughtTogether: { url: "/api/product/frequently-bought-together", method: "get" },
  ...
  // Reviews & ratings (Session 4)
  getReviews:            { url: "/api/review/list",               method: "get"  },
  submitReview:          { url: "/api/review/submit",             method: "post" },
  deleteOwnReview:       { url: "/api/review/delete",             method: "delete"},
  toggleReviewHelpful:   { url: "/api/review/toggle-helpful",     method: "post" },
  adminDeleteReview:     { url: "/api/review/admin/delete",       method: "delete"},
  adminModerateReview:   { url: "/api/review/admin/moderate",     method: "put"  },
  adminReplyReview:      { url: "/api/review/admin/reply",        method: "post" },
  // Questions & Answers (Session 4)
  getQuestions:          { url: "/api/qa/list",                   method: "get"  },
  askQuestion:           { url: "/api/qa/ask",                    method: "post" },
  answerQuestion:        { url: "/api/qa/answer",                 method: "post" },
  toggleQuestionHelpful: { url: "/api/qa/toggle-helpful",         method: "post" },
  deleteOwnQuestion:     { url: "/api/qa/delete",                 method: "delete"},
  adminDeleteQuestion:   { url: "/api/qa/admin/delete",           method: "delete"},
  adminModerateQuestion: { url: "/api/qa/admin/moderate",         method: "put"  },
